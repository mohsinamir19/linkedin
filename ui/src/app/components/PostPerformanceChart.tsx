...
const mockData = [
  { date: "Dec 13", likes: 45, comments: 12, reposts: 5, impressions: 12, engagement: 5.2 },
  { date: "Dec 14", likes: 67, comments: 18, reposts: 8, impressions: 14, engagement: 6.4 },
];
    ...
    <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
      ...
      <div className="mt-6 pt-6 border-t border-gray-200">
        <div className="grid grid-cols-4 gap-4 text-center">
          ...
          <div>
            <p className="text-2xl font-semibold text-gray-900">1K</p>
